...
then
    ...
    # read -p "Provide the total space you find on the left side of the $target_disk in numerals(eg:150 for 150GB):  " total_space
    ...
    read -p "Provide the total space you find on the left side of the provided identifier in numerals(eg:150 for 150GB):  " total_space
